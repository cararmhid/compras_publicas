                        ...
                        <td style="text-align: center;">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                       <!-- <a href="{{url('poas',$poa->id)}}" type="button" class="btn btn-secondary"><i class="bi bi-eye"></i></a>-->
                                        ...
                                        <a href="{{route('necesidads.edit' ,$poa->id)}}" type="button" class="btn btn-success"><i class="bi bi-file"></i></a>
                                        
                                       <!-- <form action="{{route('necesidads.destroy' ,$poa->id)}}" onclick="preguntar<?=$id;?>(event)" method="post" id="miFormulario<?=$id;?>">
                                            @csrf
                                            @method('DELETE')
