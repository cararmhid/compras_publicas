                           ...
                           {{method_field('PUT')}}
                            <div class="row">
                                <div class="col-md-12   ">
                                    ...
                                    <!-- CONSULTA SI EL PROCESO ES CON NEGOCIACION' -->
                                       <div class="col-md-8 form-group">
                                        <label for="negociacion">Proceso con Negociación S/N</label>
                                            <div>
                                                <input type="radio" id="negociacion_si" name="negociacion" value="si" required>
                                                <label for="negociacion_si">Sí</label>
                                            </div>
                                            <div>
                                                <input type="radio" id="negociacion_no" name="negociacion" value="no" required>
