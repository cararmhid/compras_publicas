...
<div class="content" style="margin: 10px;">
    <h1 style="color: #030a03;">Asignar Responsable para las Infimas</h1><br>
    ...
    <form action="{{ route('ruta.guardar') }}" method="POST" style="background-color: #f9f9f9; padding: 20px; border-radius: 5px;">
        @csrf
