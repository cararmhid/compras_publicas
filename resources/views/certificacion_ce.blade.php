...
<table width="100%" cellpadding="2" cellspacing="20" style="background: transparent">
	<tr>
		<td colspan="1" width="100%" height="1" valign="top" style="border: none; padding: 0cm"><p align="center">
			<font color="#6d0c0c"><font face="Droid Sans Fallback, sans-serif"><font size="1" style="font-size: 11pt"><b>CERTIFICACIÓN DE REVISIÓN</b></font></font></font>
			<font color="#6d0c0c"><font face="Droid Sans Fallback, sans-serif"><font size="1" style="font-size: 11pt"><b>EN CATÁLOGO ELECTRÓNICO</b></font></font></font></p>
		</td>
    ...
    <tr>
        <td width="100%" valign="top" style="background: transparent; border: 0px solid #000000; padding-left: 0.2cm; padding-right: 0.2cm; padding-top: 0cm; padding-bottom: 0cm">
            <p align="justify" style="font-style: normal; font-weight: normal; text-decoration: none">
                <font color="#000000"><font face="Liberation Serif, serif"><font size="8" style="font-size: 10pt"><span style="text-decoration: none">
					En cumplimiento a lo determinado en el artículo 46 de la Ley Orgánica del Servicio Nacional de Contratación
					 Pública - LOSNCP, luego de la verificación en la Herramienta Catálogo Electrónico dentro del Sistema 
					 Oficial de Contratación Pública del Ecuador (SOCE), en cuanto al requerimiento recibido, tengo a bien
					  certificar que el objeto de contratación referente a {{session('descripcion')}}, a la fecha, 
					  {{session('cat')}} se encuentra disponible en el Catálogo Electrónico; se remite el expediente a la Dirección Financiera 
					  con la finalidad de que se emita la Certificación Presupuestaria correspondiente.</span></font></font></font>
            </p>
            <br/>
        </td>
    </tr>
